class ListMinHeap:
    ...
    def _down_heap_starts_at(self, s_idx):
        node_idx = s_idx
        small_child_node_idx = self._get_small_child_node_idx(node_idx)
        while small_child_node_idx is not None and self._list[node_idx] > self._list[small_child_node_idx]:
            tmp = self._list[node_idx]
            self._list[node_idx] = self._list[small_child_node_idx]
            self._list[small_child_node_idx] = tmp
            del tmp
            node_idx = small_child_node_idx
            small_child_node_idx = self._get_small_child_node_idx(node_idx)

    def _get_small_child_node_idx(self, node_idx):
